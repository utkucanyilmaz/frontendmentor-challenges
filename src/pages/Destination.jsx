...
function Destination() {
  ...
  return (
    <main className="text-white items-center md:items-start xl:ml-16 xl:mt-20 flex flex-col gap-y-8 md:gap-y-16">
      {destination && (
        <>
          <div className="ml-8 md:mt-10 xl:mt-0 uppercase font-barlow-condensed flex gap-x-5 xl:gap-x-7 tracking-nav md:tracking-header text-base md:text-xl xl:text-28">
          ...
          <section className="flex w-full flex-col items-center xl:items-end xl:flex-row xl:justify-around">
            <div className="w-[170px] h-[170px] md:w-[300px] md:h-[300px] xl:w-auto xl:h-auto mb-4 md:mb-10 xl:mb-0">
            ...
            <div className="flex flex-col gap-y-5 md:gap-y-8 xl:gap-y-9 items-center xl:items-start text-center xl:text-start">
              ...
              <div className="pb-12 xl:pb-14 border-b border-white border-opacity-25">
              ...
              <div className="flex flex-col md:flex-row gap-y-8 gap-x-20 mt-3">
