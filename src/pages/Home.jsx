  ...
  return (
    <main className="flex justify-between items-end mt-64 mx-16">
      <div className="flex flex-col gap-y-6">
        ...
        <p className="text-tealish-blue lg:max-w-[45ch] leading-8">
      ...
      <button className="text-dark-blue bg-white uppercase rounded-full font-bellefair text-3xl h-[274px] w-[274px] relative group z-10">
        <div className="h-full w-full rounded-full bg-hover absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2  group-hover:scale-150 transition-transform -z-10 opacity-20"></div>
        Explore
      </button>
    </main>
  );
