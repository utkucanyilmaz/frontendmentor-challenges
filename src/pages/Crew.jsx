...
function Crew() {
  ...
  return (
    <main className="text-white items-center mx-6 md:mx-0 xl:ml-16 xl:mt-20 flex flex-col gap-y-16 -mb-10">
      {crewMember && (
        <>
          <div className="ml-8 md:mt-10 md:self-start xl:mt-0 uppercase font-barlow-condensed flex gap-x-5 xl:gap-x-7 tracking-nav md:tracking-header text-base md:text-xl xl:text-28">
            <span className="opacity-25">02</span> Meet Your Crew
          </div>

          <div className="xl:grid xl:grid-cols-2 flex flex-col-reverse md:flex-col items-center justify-center text-center xl:text-start">
