...
function AdviceCard({ data, getAdvice }) {
  return (
    <div className="px-6 py-10 sm:p-12 flex flex-col items-center justify-center bg-dark-grayish-blue font-monrope rounded-xl sm:rounded-2xl gap-y-6 relative mx-4 sm:mx-0">
      <div className="text-xs sm:text-sm uppercase tracking-[.36em] font-medium text-neon-green text-center">
        Advice #{data.slip.id}
      </div>

      <p className="text-light-cyan font-medium text-2xl sm:text-[28px] max-w-[20ch] sm:max-w-[25ch] text-center leading-8 sm:leading-[42px]">
        “{data.slip.advice}”
      </p>
