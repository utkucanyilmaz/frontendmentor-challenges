  ...
  return (
    <AnimatePages>
      <main className="text-white items-center xl:items-start xl:ml-16 xl:mt-20 flex flex-col min-h-screen">
        {technology && (
          <>
            <div className="md:ml-8 md:self-start md:mt-10 xl:mt-0 uppercase font-barlow-condensed flex gap-x-5 xl:gap-x-7 tracking-nav md:tracking-header text-base md:text-xl xl:text-28">
            ...
            <div className="mt-7 flex w-full flex-col-reverse xl:flex-row items-center justify-center xl:justify-between">
              ...
              <motion.div
                ...
                animate="animate"
                key={technology.name}
                className="h-auto xl:w-auto mb-14 xl:mb-0"
              >
                <picture>
                  <source
